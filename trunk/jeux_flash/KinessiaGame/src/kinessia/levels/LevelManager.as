package kinessia.levels {
	...
	public class LevelManager {
		...
		public function LevelManager() {
			...
			_levels = [];
			_levels["Level"] = [LevelA2, LevelA2, LevelA3, LevelA4, LevelA5];
			_levels["SWF"] = ["levels/levelA2.swf", "levels/levelA2.swf", "levels/levelA3.swf", "levels/levelA4.swf", "levels/levelA5.swf"];
