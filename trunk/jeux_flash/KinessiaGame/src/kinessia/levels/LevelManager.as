package kinessia.levels {
	...
	public class LevelManager {
		...
		public function LevelManager() {
			...
			_levels = [];
			_levels["Level"] = [LevelA3, LevelA2, LevelA3, LevelA4, LevelA5];
			_levels["Name"] = ["A3", "A2", "A3", "A4", "A5"];
			_levels["SWF"] = ["levels/levelA3.swf", "levels/levelA2.swf", "levels/levelA3.swf", "levels/levelA4.swf", "levels/levelA5.swf"];
